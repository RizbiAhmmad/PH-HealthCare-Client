...
const ViewScheduleDialog = ({
  ...
  const scheduleDetails = data && data.success
    ? {
        ...schedule,
        ...(data as ApiResponse<ISchedule>).data,
        appointments: (data as ApiResponse<ISchedule>).data.appointments ?? schedule?.appointments,
        doctorSchedules: (data as ApiResponse<ISchedule>).data.doctorSchedules ?? schedule?.doctorSchedules,
      }
    : schedule
