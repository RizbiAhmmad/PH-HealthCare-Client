...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-background py-16 sm:py-24 lg:py-32">
      ...
      <div className="absolute inset-0 z-0 bg-primary/5 mask-[radial-gradient(ellipse_at_center,transparent_20%,black)]" />
      <div className="absolute top-0 right-0 -z-10 h-125 w-125 rounded-full bg-primary/10 blur-[100px] md:top-20 md:right-20" />
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          <div className="flex flex-col justify-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="max-w-150 text-lg text-muted-foreground sm:text-xl">
